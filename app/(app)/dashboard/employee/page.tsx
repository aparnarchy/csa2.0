...
export default async function EmployeeDashboard() {
  ...
  // dashboard, and if there's anything to do we send the user through the
  // full-screen check-in flow first — which itself ends by routing back here.
  // "Anything to do" = this week's fresh questions, earlier-week pending ones,
  // OR an open low-score recommendation still awaiting a return check-in (so the
