...
export interface PillarRca {
  ...
  feelings: string[]; // 2–3 short "you might be feeling…" words for the dashboard
}
...
export const RCA_KNOWLEDGE: Record<PillarId, PillarRca> = {
  meaningful_work: {
    ...
    factor: "It's strongest around Meaningful Work, where the spark in what you do day to day is fading",
    root: "Your tasks rarely connect to something you personally care about, so they feel like just 'getting through it.'",
    actions: [
      "Pick one task this week and tie it to a goal you actually care about, and write the 'why' on a sticky note.",
      "Tell your manager which kind of work energises you most, and ask for one more slice of it.",
      "Tonight, note one thing that felt meaningful today, to train your brain to spot it.",
    ],
    ...
    feelings: ["Flat", "Going through the motions", "Quietly checked out"],
  },
  growth: {
    ...
    actions: [
      ...
      "Write down the next role you'd want, since naming the gap gives growth a target.",
    ],
    ...
    feelings: ["Bored", "Restless", "Prone to Monday blues"],
  },
  culture: {
    ...
    actions: [
      "Recognise a teammate openly this week, since connection compounds when you start it.",
    ...
    feelings: ["On the outside", "Unseen", "A bit drained"],
  },
  compensation: {
    ...
    factor: "It's strongest around Compensation, where the value exchange feels unclear or unfair",
    root: "You're not sure your pay reflects your worth or how it compares, so effort starts to feel one-sided.",
    actions: [
      "Document your last three wins with impact and numbers, to start your case file.",
